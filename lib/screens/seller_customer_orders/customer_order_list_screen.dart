...
class SellerOrdersList extends StatefulWidget {
  const SellerOrdersList({Key? key}) : super(key: key);
...
class _SellerOrdersListState extends State<SellerOrdersList> {
  ...
  Future getDetails(BuildContext context, String date) async {
    ...
    final response = date == ''
        ? await http.get(
            Uri.parse('${Constant.KEY_URL}/api/get-seller-orders'),
                                                ...
                                                children: [
                                                  ...
                                                  Padding(
                                                    padding: const EdgeInsets
                                                        ...
                                                        vertical: 8.0),
                                                    child: Text(
                                                        'Total Price : ₹${order["order_details"]["total"]}',
                                                        style: TextStyle(
                                                            fontSize: 16.0)),
                                                  ),
                                                  Padding(
                                                    padding: const EdgeInsets
                                                        ...
                                                        vertical: 8.0),
                                                    child: Text(
                                                        'Order Status : ${order["order_details"]["status"]}',
                                                        style: TextStyle(
                                                            fontSize: 16.0)),
                                                  ),
                                                  Padding(
                                                    padding: const EdgeInsets
                                                        ...
                                                        vertical: 8.0),
                                                    child: Text(
                                                        '${order["order_details"]["is_assigned"] ? "Order is assigned to a distributor" : "Order is not assigned yet"}',
                                                        style: TextStyle(
                                                            fontSize: 16.0)),
                                                  ),
                                                  Container(
