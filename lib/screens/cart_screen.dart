      ...
      setState(() {
        ...
        _menuItems = List.generate(
          ...
          (i) => DropdownMenuItem(
            ...
            child: Text("${smallSentence(message[i]["zone_name"])}"),
          ),
        );
        print(zoneList[0]);
        print(">>>>>>>>>>>>>>>>>>>>>>>>>>");
  ...
  Future verifyUID(BuildContext context, String number, String uid) async {
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        ...
        cityValue = user_data["city"] == null ? null:user_data["city"];
        stateValue = user_data["state"] == null ? null:user_data["state"];
                    ...
                    children: [
                                      ...
                                      children: [
                                        DropdownButton<int>(
                                          ...
                                          items: List.generate(
                                            zoneList.length,
                                            (i) => DropdownMenuItem(
                                              value: zoneList[i]["zone_id"],
                                              child: Text(
                                                  "${smallSentence(zoneList[i]["zone_name"])}"),
                                            ),
                                          ),
                                          // items: _menuItems,
                                          value: _value,
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                           "Prepaid",// "Pay On Delivery", commented by abhishek, on 29-11-2023
                            style: TextStyle(
                                fontSize: 16, fontWeight: FontWeight.bold),
                          ),
                        ],
                                    ...
                                    return SizedBox(
                                      ...
                                      child: Center(
                                        child: Column(
                                          mainAxisAlignment: MainAxisAlignment.center,
                                          children: <Widget>[
                                            Text('Scan and pay with any BHIM UPI app', style: TextStyle(
                                              fontWeight: FontWeight.bold,
                                              fontSize: 14,
                                            ),),
                                            SizedBox(height: 10,),
                                            Image.asset('assets/images/qr_payment.png',
                                                width: 200,
                                                height: 200),
                                            SizedBox(height: 10,),
                                            Text('Please make payment on this QR.\nAfter successful verification of payment,\nwe will ship your order',
                                                textAlign: TextAlign.center
                                            ),
                                            SizedBox(height: 10,),
                                            ElevatedButton(
