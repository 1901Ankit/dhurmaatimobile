...
class ProductsList extends StatefulWidget {
  ...
  int raw_id;
  List<dynamic> object;
  ProductsList(this.raw_id, this.object);
                              ...
                              child: Column(
                                children: [
                                  Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        // SizedBox(width: 20),
                                        Text(
                                          "    ${widget.object[index]["product_name"]}"
                                              .toUpperCase(),
                                          style: TextStyle(
                                  ...
                                  CarouselSlider.builder(
                                    itemCount: widget
                                        .object[index]["product_images"].length,
                                    itemBuilder: (BuildContext context, int ind,
                                      ...
                                      return Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          image: DecorationImage(
                                            image: NetworkImage(
                                                '${widget.object[index]["product_images"][ind]["url"]}'),
                                            fit: BoxFit.cover,
                                          ),
                                        ),
                                      );
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                            ...
                                            "₹ ${widget.object[index]["unit_price"]}")
                                    ...
                                    child: Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                              ...
                                              textDirection: TextDirection.ltr,
                                              textAlign: TextAlign.right,
                                              "${widget.object[index]["quantity"]} packages"
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                            ...
                                            textDirection: TextDirection.ltr,
                                            textAlign: TextAlign.right,
                                            "${widget.object[index]["availability"]}"
                                            // "${widget.datapass.farmes[index]["harvest_month"]}"
                                            ),
                                      ],
                                    ),
